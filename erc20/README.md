...
2. In the list of network, use the button *+ Add network*, *Add a network manually*.
...
3. In the list of accounts, import this private keys:
   1. Selected the list of accounts, push *+ Add account or hardw wallet*.
...
4. Change to *SOLIDITY COMPILER*, set compiler version _0.6.0_, EVM VERSION to _istanbul_ and use the button *Compile ERC20.sol*.
...
1. Open Metamask and connect the 3 imported accounts with *Localhost 8545* to RemixIDE
   ...
   3. Click on _Connect account_ button.
   4. Select the 3 imported accounts and push _Next_ button.
